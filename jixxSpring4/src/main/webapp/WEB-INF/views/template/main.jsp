...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <!-- Logo -->
      <a href="index2.html" class="logo"><img src="images/logo.png" alt="Logo">
      </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">
          <a href="index.html"> <i class="fa fa-sun-o"></i>All Threads </a>
        </li>
      </ul>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">
          <a href="index.html"> Channels &nbsp; &nbsp;<i class="fa fa-plus-circle"></i></a>
          <li><a href="#"> <i class="fa fa-asterisk"></i>Channel 1</a></li>
          <li><a href="#"><i id="icon2" class="fa fa-lock"></i>Channel 2</a></li>
        </li>
        <li class="header">
          <a href="index.html"> Direct Messages &nbsp; <i class="fa fa-plus-circle"></i> </a>
          <li><a href="#"><i class="fa fa fa-user"></i>ì¬ë 1</a></li>
          <li><a href="#"><i class="fa fa-users"></i>ì¬ë 2</a></li>
        </li>
        <li class="header">
          <a href="index.html"> Invate People &nbsp; <i class="fa fa-plus-circle"></i> </a>
        </li>
              ...
              <div class="input-group-btn">
                <div class="btn-group">
                  ...
                  <div tabindex="-1" aria-hidden="true" role="menu" class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, -12px, 0px); top: -134px; left: 0px; will-change: transform;">
                    ...
                    <li class="header btnlist">Your computer<input type="file"></li>
                  </div>
                  <br>
                </div>
              </div>
