          ...
          <div class="col-lg-16">
            <div class="card">
              <div class="card-body card-block">
                ...
                <br>
                <label class="form-text text-muted"></label>
                ...
                <form action="" method="post" class="form-horizontal">
                  ...
                  <div class="row form-group">
                    <div class="col-5">
                     ...
                     <input type="email" name="fullname" placeholder="" class="form-control"><br>
                     <label class="control-label mb-1">Display name(optional)</label>
                     <input type="email" name="displayname" placeholder="" class="form-control"><br>
                     <label class="form-text text-muted">This could be your first name, or a nickname - however you'd like people to refer to you in JIXX</label>
                   </div>
                 </div>
               </form>
               <br>
