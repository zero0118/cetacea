...
public class Post {
	...
	private Channel channel; //저장소의 어디 채널에 해당하는 것인지.
	
	public Post () {}

	public Post(int post_id, int repost_id, String nickname, String content, int user_id, Date logdate, Date update,
			String file_thumbnail, String file_original, int post_status, Channel channel) {
		super();
	...
	public String toString() {
		return "Board [post_id=" + post_id + ", repost_id=" + repost_id + ", nickname=" + nickname + ", content="
